...
{
  d = new StringPrivate; // d is unicode

  if(v.isEmpty())
    return;

  //ISO885XXX   may be gbk contain two byte ,
  //so this convertion is abandoned in win32
  //we use win32 api multibyte2widechar instead
  if( t == UTF8) 
  {
